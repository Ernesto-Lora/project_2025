...
def get_params_l(xml_file, csv_file, target_var, Optimizer_fun,
                max_iter,
               params_file_name, betas_file_name,**kargs ):
    ...
    # 5. Run optimizer
    gradient_func  = lambda betas: bn.calculate_gradient(betas, df)
    optimizer = Optimizer_fun(objective, gradient_func, dim=bn.total_params, max_iter=max_iter) # Low iters for demo
